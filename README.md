...
4. Once finished, run **Step 2** on the output folder generated by Step 1.
 ...
 IMPORTANT:
    ...
    Make sure the **Set Measurements** parameters are correctly configured. Recommendation: Go to Analyze > Set Measurements... and ensure that Area, Area Fraction, Limit to Threshold, and Display Label are checked.
...
| :---: | :---: | :---: |
| ![Original](screenshots/original_2.tif) | ![DAB](screenshots/(Colour_2).tif) | ![Mask](screenshots/mask.jpg) |![Measurements](screenshots/result.png) |
